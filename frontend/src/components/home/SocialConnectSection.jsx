...
const SocialConnectSection = () => {
  const socialLinks = [
    {
      name: 'Instagram',
      url: 'https://instagram.com/finiquewindows',
      icon: (
      ...
      brandColor: 'hover:text-pink-500 hover:border-pink-500/30 hover:bg-pink-50/30',
    },
    {
      name: 'Facebook',
      url: 'https://facebook.com/finiquewindows',
      icon: (
        <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" />
        </svg>
      ),
      brandColor: 'hover:text-blue-600 hover:border-blue-600/30 hover:bg-blue-50/30',
    },
    {
      name: 'YouTube',
      url: 'https://youtube.com/@finiquewindows',
      icon: (
        <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      brandColor: 'hover:text-red-600 hover:border-red-600/30 hover:bg-red-50/30',
    },
  ];
  ...
  return (
    ...
    >
      <div className="container-shell flex flex-col items-center justify-center gap-6 text-center">
        <motion.div variants={slideUp} className="flex flex-col items-center gap-5">
